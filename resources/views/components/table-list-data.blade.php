        ...
        <table class="w-full border-collapse min-h-[300px]">
            <thead>
                <tr class="text-basicfont text-sm font-semibold">
                    ...
                    <th class="border-b text-left">Tag ID Sapi</th>
                    <th class="border-b text-left">BCS Score</th>
                    <th class="border-b text-left">Perhatian Khusus</th>
                    <th class="border-b text-left">Tangal Pengecekan</th>
                    <th class="border-b text-left">Detail</th>
                </tr>
            </thead>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($bcsData as $item)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-4 text-sm">
                            <a href="{{ route('detail', $item->cow->id) }}">
                                <x-primary-button>
                                    {{ __('Detail') }}
                                </x-primary-button>
                            </a>
